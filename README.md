...
Final Accuracy: ~92% on test data, showing strong capability to classify e-waste components reliably.

4-WEEK PROGRESS:

| Week | Task                        | Outcome                  |
| ---- | --------------------------- | ------------------------ |
| 1    | Collected & cleaned dataset | Ready for model training |
| 2    | Trained CNN model           | Achieved good accuracy   |
| 3    | Fine-tuned & tested         | Improved performance     |
| 4    | Built interface & report    | Working prototype ready  |
